...
- The visual diagrams in this build use an icon-and-card system (colors,
  icons, simple bar/dialogue components) rather than the fully bespoke
  illustrations from the earlier static HTML mockups. The content and logic
  are complete; further visual polish per-dimension is a follow-up, not a
