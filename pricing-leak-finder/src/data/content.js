...
export const DIMENSIONS = {
  packaging: {
    ...
    whatItIs: 'how you explain what\u2019s actually included in your price',
    ...
    soundsLines: [
      { who: 'you', text: '"{{PRICE}} for the day."' },
    ...
    quickWin: 'Write down three things in your package and give each one a made-up dollar value. Say the total out loud before you say the real price \u2014 like "8 hours, a second shooter, and the album add up to {{PRICE}}."',
    ...
    before: '"It\u2019s {{PRICE}} for the day."',
    after: '"You\u2019re getting 8 hours of coverage, a second shooter, and your full album \u2014 altogether that\u2019s about {{PRICE}} in value, and that\u2019s your investment."',
    ...
    archetypeTemplates: {
      spreadsheet: { line: '"Here\u2019s exactly what\u2019s included: 8hr coverage, second shooter, and the full album \u2014 {{PRICE}} total, broken down piece by piece."', why: 'They were going to build this comparison themselves, using whatever numbers they could find. Handing it to them in writing means you control what the comparison actually shows.' },
      stickerShock: { line: '"I know {{PRICE}} is more than you might have expected \u2014 can I walk you through what\u2019s actually in it before we talk numbers?"', why: 'Their number likely came from somewhere unrelated to your market. Getting permission to reset the frame first means the price lands after context, not before it.' },
      socialProof: { line: '"Here\u2019s what\u2019s included, and here\u2019s what a past couple said about it [testimonial]."', why: 'Pairing the stack with proof does two jobs at once \u2014 it shows the value and lets someone else vouch for it, which matters more to this archetype than your word alone.' },
      alreadySold: { line: '"Your investment is {{PRICE}}, and it includes everything we talked about."', why: 'They\u2019ve already decided. A long walkthrough here risks introducing doubt that wasn\u2019t there \u2014 say the stack once, briefly, and move to booking.' },
      knowsWhatTheyWant: { line: '"For what you described, that\u2019s {{PRICE}} \u2014 covering the exact things you mentioned."', why: 'They want confirmation, not a pitch. Matching the stack directly to what they already asked for gets them to yes fastest.' },
    },
    flowchart: [
  ...
  anchoring: {
    ...
    whatItIs: 'whether you offer one price, or a few options for couples to choose between',
    ...
    soundsLines: [
      { who: 'you', text: '"My package is {{PRICE}}."' },
    ...
    before: '"My package is {{PRICE}}."',
    after: '"I\u2019ve got three ways we can work together \u2014 Essentials at {{TIER_LOW}}, Signature at {{PRICE}}, and Premium at {{TIER_HIGH}}. Most couples go with Signature."',
    ...
    archetypeTemplates: {
      spreadsheet: { line: '"I\u2019ve got three options \u2014 Essentials at {{TIER_LOW}}, Signature at {{PRICE}}, and Premium at {{TIER_HIGH}}. Here\u2019s exactly what\u2019s different between them."', why: 'Give the full comparison unprompted \u2014 they were going to build one anyway, so make sure it\u2019s built from your real numbers, not guesses.' },
      stickerShock: { line: '"Before I give you one number \u2014 I\u2019ve got three ways we can work together, starting at {{TIER_LOW}}."', why: 'Leading with a range instead of a single price softens the anchor they walked in with, so their budget number doesn\u2019t get compared against just one figure.' },
      socialProof: { line: '"Most couples end up choosing Signature at {{PRICE}} \u2014 it\u2019s the one that gets the best feedback afterward."', why: 'Naming what other couples picked functions as its own kind of proof, which this archetype weighs more heavily than the options alone.' },
      alreadySold: { line: '"I\u2019ve got three packages \u2014 Signature at {{PRICE}} is what most couples like you go with."', why: 'Keep it brief here \u2014 they don\u2019t need a deep comparison, just enough to confirm the choice they\u2019ve basically already made.' },
      knowsWhatTheyWant: { line: '"Based on what you described, Signature at {{PRICE}} covers everything you listed. Want me to send the contract?"', why: 'Skip presenting all three tiers in depth \u2014 confirm the one that matches what they told you they want, and move forward.' },
    },
    flowchart: [
  ...
  delivery: {
    ...
    whatItIs: 'how confidently you actually say your price out loud',
    ...
    soundsLines: [
      { who: 'you', text: '"So it\u2019s, um, {{PRICE}}, but I\u2019m flexible if that\u2019s a lot."' },
      { who: 'them', text: '"Could you maybe do {{OFFER_LOW}}?"' },
    ],
    ...
    before: '"So it\u2019s, um, {{PRICE}}, but like, we can talk about it."',
    after: '"Your investment is {{PRICE}}." [Silence.]',
    ...
    archetypeTemplates: {
      spreadsheet: { line: '"Your investment is {{PRICE}}." [Pause.] "Happy to send that breakdown in writing if it\u2019s easier to sit with."', why: 'Say the price plainly first \u2014 don\u2019t lead with the breakdown just to dodge the silence. Offer it after the pause, as a genuine convenience, not a way to soften the number.' },
      stickerShock: { line: '"Your investment is {{PRICE}}." [Pause.]', why: 'This archetype is the real test of the fix \u2014 the pull to soften or discount immediately is strongest here. The discomfort of holding the pause is exactly what\u2019s worth sitting through.' },
      socialProof: { line: '"Your investment is {{PRICE}} \u2014 and here\u2019s what a past couple said, if it\u2019s helpful before you decide." [Then stop talking.]', why: 'This is the one archetype where adding something after the price genuinely helps \u2014 what they need isn\u2019t more confidence from you, it\u2019s a second voice besides yours.' },
      alreadySold: { line: '"Your investment is {{PRICE}}." [Pause \u2014 say nothing else.]', why: 'They\u2019ve basically decided already. Any extra sentence after the number risks planting doubt that genuinely wasn\u2019t there a moment earlier.' },
      knowsWhatTheyWant: { line: '"Your investment is {{PRICE}}, and that includes everything you asked about. Want me to send the contract?"', why: 'Short and flat is correct here \u2014 this archetype reads over-explaining as a red flag, not reassurance.' },
    },
    flowchart: [
  ...
  defense: {
    ...
    whatItIs: 'how you respond the moment someone pushes back on your price',
    ...
    archetypeTemplates: {
      spreadsheet: { line: '"What makes you say that?" then let them walk through their numbers.', why: 'They usually want to be heard analytically, not talked out of their concern \u2014 the question gives them room to actually explain the math they\u2019re working from.' },
      stickerShock: { line: '"What makes you say that?"', why: 'Often reveals a number they picked up somewhere entirely unrelated to your market \u2014 useful to know before you respond to the wrong thing.' },
      socialProof: { line: '"What makes you say that?"', why: 'For this archetype, the honest answer is often "I don\u2019t know if this is normal" \u2014 a question proof can answer far better than a discount ever could.' },
      alreadySold: { line: '"What makes you say that?"', why: 'Pushback from this archetype is rare. If it happens, they may just be double-checking rather than genuinely objecting \u2014 the question confirms which one it is.' },
      knowsWhatTheyWant: { line: '"What makes you say that?"', why: 'This archetype rarely objects without a specific reason, so the question usually gets a precise, solvable answer fast rather than a vague one.' },
    },
    flowchart: [
  ...
  discountReflex: {
    ...
    whatItIs: 'how easily your price moves the moment someone hesitates',
    ...
    soundsLines: [
      { who: 'you', text: '"It\u2019s {{PRICE}}, but I could do {{OFFER_HIGH}} if that helps."' },
      { who: 'them', text: '"Oh, could you do {{OFFER_LOW}}?"' },
    ],
    ...
    longTerm: 'Decide in advance what you\u2019ll trade for a discount instead of giving one for free \u2014 like "{{TRADE_SMALL}} off for a referral to another couple."',
    before: '"I could knock {{TRADE_SMALL}} off if that helps."',
    after: '"I can\u2019t move on the price, but if you introduce me to two other couples, I\u2019d take {{TRADE_SMALL}} off. Fair?"',
    ...
    archetypeTemplates: {
      spreadsheet: { line: '"I can\u2019t move on the total, but here\u2019s exactly what a trade could look like: refer two couples, I\u2019ll take {{TRADE_SMALL}} off \u2014 here\u2019s that math."', why: 'They want to see the logic, not just hear a number \u2014 laying out the trade explicitly respects how they make decisions.' },
      stickerShock: { line: '"I hear you on budget \u2014 I can\u2019t cut the price outright, but locking in this week could save you {{TRADE_MED}}."', why: 'A trade, not a bare discount, for the archetype most likely to trigger this reflex \u2014 it gives them a real reason to move without teaching them your price is soft.' },
      socialProof: { line: '"I don\u2019t discount outright, but if you know another engaged couple, I\u2019d take {{TRADE_SMALL}} off for the introduction."', why: 'Fits naturally since this archetype already talks about you to others \u2014 the trade just formalizes something they were likely to do anyway.' },
      alreadySold: { line: 'Don\u2019t offer a discount unprompted \u2014 say the price plainly and move to booking.', why: 'If they ask, offer the add-on trade instead of a cut. Otherwise, raising a discount they didn\u2019t ask for can introduce doubt where there wasn\u2019t any.' },
      knowsWhatTheyWant: { line: 'No discount conversation needed unless they raise it themselves.', why: 'This archetype came ready to book at the stated price \u2014 bringing up a discount preemptively just invites a negotiation that wasn\u2019t going to happen otherwise.' },
    },
    flowchart: [
  ...
  proofTiming: {
    ...
    whatItIs: 'whether reviews and past results show up before the price, or only after someone doubts you',
    ...
    soundsLines: [
      { who: 'you', text: '"It\u2019s {{PRICE}} for the day."' },
    ...
    after: '"Before we get to the price \u2014 here\u2019s what a couple from last season said... Now, here\u2019s what that looked like for you: {{PRICE}}."',
    ...
    archetypeTemplates: {
      spreadsheet: { line: '"Here\u2019s a written summary of client feedback alongside the package breakdown."', why: 'Proof works best for this archetype when it sits inside the same document as the numbers, not as a separate afterthought they have to go looking for.' },
      stickerShock: { line: '"Before we even get to pricing \u2014 here\u2019s what a similar-budget couple said [testimonial]. Now here\u2019s what that looked like: {{PRICE}}."', why: 'Proof shown before the number softens the anchor they walked in with, so the price lands after trust is already partly built.' },
      socialProof: { line: '"Here\u2019s what one of last season\u2019s couples said \u2014 happy to connect you directly if you\u2019d like to ask them anything."', why: 'This archetype benefits most from proof of anyone \u2014 a real introduction, not just a quote on a page, is worth the extra step for them specifically.' },
      alreadySold: { line: 'Use proof sparingly \u2014 one short mention is enough.', why: 'Over-proving to someone who\u2019s already decided can accidentally introduce doubt that wasn\u2019t there a moment earlier.' },
      knowsWhatTheyWant: { line: 'Skip proof almost entirely unless asked.', why: 'This archetype wants confirmation, not persuasion \u2014 unsolicited proof can read as trying to sell them on something they\u2019ve already decided.' },
    },
    flowchart: [
...
export const COMPOUNDS = {
  packagingDiscountReflex: {
    ...
    before: '"That\u2019s more than we hoped." \u2192 "I could do {{OFFER_HIGH}}."',
    after: '"That\u2019s more than we hoped." \u2192 "Just to be clear on what\u2019s included: 8 hours, a second shooter, and the full album \u2014 about {{PRICE}} in value. If budget\u2019s tight, I could take {{TRADE_MED}} off for a referral."',
    archetypeTemplates: {
      spreadsheet: { line: '"Here\u2019s the full breakdown [stack]. If budget\u2019s tight, I could take {{TRADE_MED}} off for a referral \u2014 but the stack itself doesn\u2019t change."', why: 'Show the stack first, always \u2014 the trade only makes sense once there\u2019s something real on the table to trade against.' },
      stickerShock: { line: '"I know {{PRICE}} is more than expected \u2014 here\u2019s exactly what that includes [stack]. If it\u2019s still a stretch, {{TRADE_MED}} off for booking by Friday."', why: 'Stack first, trade second \u2014 this archetype is the most likely to trigger both leaks at once, so addressing them in order matters.' },
      socialProof: { line: '"Here\u2019s what\u2019s included [stack], and here\u2019s what a past couple said [testimonial]. If you know another couple who\u2019d be a fit, {{TRADE_MED}} off for the intro."', why: 'Stack, then proof, then trade \u2014 each layer does a different job for an archetype that weighs all three.' },
      alreadySold: { line: '"Your investment is {{PRICE}}, and it includes [stack, briefly]. I\u2019ll send the contract today."', why: 'Say the stack once, plainly, then move straight to booking \u2014 no need to build a case they\u2019ve already accepted.' },
      knowsWhatTheyWant: { line: '"For what you described, that\u2019s {{PRICE}} \u2014 covering [specific items]. Want me to send the contract?"', why: 'Match the stack directly to what they asked for and skip general selling \u2014 they\u2019re confirming, not shopping.' },
    },
    flowchart: [
  ...
  deliveryDefense: {
    ...
    before: '"So it\u2019s, um, {{PRICE}}, but I\u2019m flexible."',
    after: '"Your investment is {{PRICE}}." [Pause.] If pushback: "What makes you say that?" [Pause again.]',
    archetypeTemplates: {
      spreadsheet: { line: '"Your investment is {{PRICE}}." [Pause.] "Happy to send that breakdown in writing if it\u2019s easier to sit with."', why: 'Say the price plainly first, then offer the breakdown as a convenience after the pause \u2014 not as a way to avoid holding the silence.' },
      stickerShock: { line: '"Your investment is {{PRICE}}." [Pause.] Them: "That\u2019s more than we hoped." You: "What makes you say that?" [Pause again.]', why: 'Two pauses back to back will feel unnatural at first \u2014 that discomfort is exactly what\u2019s worth practicing through with this archetype specifically.' },
      socialProof: { line: '"Your investment is {{PRICE}} \u2014 and here\u2019s what a past couple said [testimonial]." [Then stop talking.]', why: 'This archetype needs a second voice besides yours \u2014 offer it once, briefly, then still let the silence do its job.' },
      alreadySold: { line: '"Your investment is {{PRICE}}." [Pause \u2014 say nothing else.]', why: 'They\u2019ve already decided. Restraint is the entire skill here \u2014 don\u2019t accidentally manufacture doubt with an extra sentence.' },
      knowsWhatTheyWant: { line: '"Your investment is {{PRICE}}, covering everything you asked about. Want me to send the contract?"', why: 'Short and flat, straight to the next step \u2014 this archetype wants confirmation, not conversation.' },
    },
    flowchart: [
...
export const ARCHETYPE_DETAIL = {
  spreadsheet: {
    title: 'They\u2019re not doubting you \u2014 they\u2019re doing due diligence.',
    text: 'This couple isn\u2019t trying to catch you overcharging. They make big decisions by comparing options side by side, and a wedding is the biggest purchase either of them has made. If you don\u2019t hand them the comparison yourself, they\u2019ll build it anyway \u2014 using whatever numbers they can find, which usually favors whoever\u2019s cheapest on paper. Give them the breakdown before they have to go looking for it, and you control what the comparison actually shows.',
  },
  stickerShock: {
    title: 'Their number came from somewhere that has nothing to do with your market.',
    text: 'A blog post, a friend\u2019s wedding two years ago, a Pinterest budget graphic \u2014 that\u2019s usually where the number in their head actually came from, not any real research into what photography costs where you work. Arguing with that number puts you in a fight you can\u2019t win, since you\u2019d be contradicting something they already believe. The better move is resetting the frame first, before defending the price at all.',
  },
  socialProof: {
    title: 'They\u2019re borrowing confidence from people who aren\u2019t in the room.',
    text: 'This couple doesn\u2019t doubt your work so much as they doubt their own ability to judge it. Knowing how other couples felt afterward matters more to them than your portfolio alone, because someone else\u2019s lived experience feels like more reliable evidence than photos ever could. The fastest way to earn their yes is handing them exactly that kind of proof before they go looking for it themselves.',
  },
  alreadySold: {
    title: 'They already decided. Don\u2019t accidentally talk them out of it.',
    text: 'This is the trickiest archetype to get right, because the risk isn\u2019t losing them on price \u2014 it\u2019s seeming unsure about a price they were never going to question. A flinch, an over-explanation, or an unprompted discount can introduce doubt that genuinely wasn\u2019t there a moment earlier. The job here is almost entirely restraint: say the number plainly, once, and let the silence sit.',
  },
  knowsWhatTheyWant: {
    title: 'They\u2019re confirming a decision, not making one.',
    text: 'This couple has already done the thinking \u2014 they know what they want, when they want it, and roughly what it should cost. A long pitch reads as a red flag to them, not reassurance, because it suggests you\u2019re trying to sell them on something they\u2019ve already decided. State the price plainly, confirm it covers what they asked for, and move straight to the next concrete step.',
  },
};
...
export const OBJECTIONS = [
  {
    featured: true,
    q: '"We got a quote for {{COMPETITOR}} from someone else."',
    a: '"What\u2019s included in that quote? Want to make sure we\u2019re comparing the same thing."',
    why: 'Most cheaper quotes are missing something yours includes \u2014 fewer hours, no second shooter, no album. The comparison usually falls apart the moment the actual inclusions get named out loud, and the couple often hasn\u2019t compared apples to apples themselves yet.',
  },
  {
    featured: true,
    q: '"My cousin\u2019s shooting for free, can you do a friend price?"',
    a: '"Can\u2019t discount the full package, but I do have a smaller option just for backup coverage."',
    why: 'Free isn\u2019t a price point you can rationally compete against \u2014 discounting your full offer to compete with it just trains couples to expect the same next time. Building a genuinely smaller, real product solves the actual need instead.',
  },
  {
    q: '"Can we get a discount if we book today?"',
    a: '"I don\u2019t discount for speed, but I can hold your date for 48 hours while you decide."',
    why: 'This removes the urgency reason for a discount without creating a new one \u2014 they still get a reason to decide soon, just not one that costs you money.',
  },
  {
    q: '"We need to check with whoever\u2019s paying."',
    a: '"Of course \u2014 want me to put together a one-page summary you can send them directly?"',
    why: 'Puts the stack directly in front of the actual decision-maker instead of relying on a secondhand retelling that usually loses the details that made the price make sense.',
  },
  {
    q: '"That\u2019s more than we expected to spend on photography."',
    a: '"What makes you say that?" Then genuine silence.',
    why: 'Finds out whether the real issue is the number itself, or something in the stack that isn\u2019t landing \u2014 those need completely different responses, and guessing wrong wastes the conversation.',
  },
  {
    q: '"Do you have anything cheaper?"',
    a: '"I do have a smaller option \u2014 want me to walk you through what\u2019s different, so you know exactly what you\u2019d be trading off?"',
    why: 'Frames the smaller tier as a real trade-off, not an apology or a downgrade \u2014 they choose it with full information instead of assuming it\u2019s just "less."',
  },
];

export const TRADE_MENU = [
  { name: 'Referral Trade', line: '"I can\u2019t move on price, but if you introduce me to two other couples, I\u2019d take {{TRADE_SMALL}} off. Fair?"', why: 'Turns a request for a discount into new leads \u2014 you\u2019re not just losing margin, you\u2019re buying future bookings with it.' },
  { name: 'Review Trade', line: '"If you\u2019re open to an honest review after the wedding, I can include the sneak peek upgrade at no cost."', why: 'Costs you almost nothing to deliver, and reviews compound \u2014 each one makes the next couple\u2019s Proof Timing easier to fix too.' },
  { name: 'Faster-Deposit Trade', line: '"I can do {{TRADE_MED}} off if we lock in the deposit and contract by this Friday."', why: 'You get certainty and cash flow sooner, which is worth something real \u2014 this isn\u2019t a discount for nothing, it\u2019s a discount for a genuine trade.' },
  { name: 'Add-On Trade', line: '"Instead of a discount, I could include the engagement session at no charge."', why: 'Protects your day-rate number, which matters for how you\u2019re perceived long-term, while still giving the couple something that feels like a real win.' },
];
...
export const SIMULATIONS = [
  {
    ...
    lines: [
      { who: 'you', text: 'Here\u2019s the breakdown \u2014 8hr coverage, second shooter, sneak peek, full album \u2014 comes to {{PRICE}} total.' },
  ...
  },
  {
    ...
    lines: [
      { who: 'you', text: 'Your investment is {{PRICE}}.' },
      { who: 'them', text: 'Wow, that\u2019s more than we were thinking.' },
      { who: 'you', text: 'What makes you say that?' },
      { who: 'them', text: 'We just figured photography would be more like {{BUDGET_ASSUMED}}.' },
      { who: 'you', text: 'That makes sense \u2014 a lot of couples start there. Can I walk you through what\u2019s in the {{PRICE}}?' },
    ],
  ...
  },
  {
    ...
    lines: [
      { who: 'them', text: '[Other photographer] quoted us {{OFFER_LOW}} for basically the same thing.' },
      { who: 'you', text: 'Good to know \u2014 what\u2019s included in their {{OFFER_LOW}}?' },
  ...
  },
  {
    ...
    lines: [
      ...
      { who: 'you', text: 'Totally understand wanting to keep it in the family. I can\u2019t discount the full day, but I have a 3-hour ceremony-and-portraits option at {{BACKUP}}.' },
