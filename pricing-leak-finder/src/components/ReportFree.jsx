  ...
  return (
    <>
      ...
      <Card style={{ marginBottom: 16, background: 'var(--mint-light)', border: 'none' }}>
        ...
        <CapText>
          <b>{DIMENSIONS[healthiest].name}</b> is the one part of your pricing conversations that's already working well — worth knowing, so you don't spend time fixing something that isn't actually broken.
        </CapText>
      </Card>
